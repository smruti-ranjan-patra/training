	...
	<div class="container">
		<div class="col-sm-offset-2 col-sm-8">
			<div class="panel panel-default">
				...
				<div class=" form-group text-center">
					<a class='btn btn-primary' id='ig' href="{{ route('home') }}"><i class="fa fa-instagram" style="width:16px; height:20px"></i></a>
					<a class='btn btn-primary' id='ig' href="{{ route('home') }}" style="width:12em; height:37px;"> Sign in with Instagram</a>
				</div>
...
@section('js-css')
	...
	<style type="text/css">
		#ig { border-color: #3F729B; background-color: #3F729B; color:#FFF;}
		#ig:hover { border-color: #24547A; background-color: #24547A; color:#FFF;}
	</style>
	<!-- jQuery -->
