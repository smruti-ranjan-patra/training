...
<?php
	...
	if (isset($emp_data) && !empty($emp_data))
	{
		...
		$email = $emp_data[0]->email;
		$prefix_2 = ($emp_data[0]->prefix == 'ms') ? true : null;
		$prefix_3 = ($emp_data[0]->prefix == 'mrs') ? true : null;
		$gender_2 = ($emp_data[0]->gender == 'female') ? true : null;
		$gender_3 = ($emp_data[0]->gender == 'others') ? true : null;
		$dob = $emp_data[0]->dob;
		$marital_status_2 = ($emp_data[0]->marital_status == 'married') ? true : null;
		$employment_2 = ($emp_data[0]->employment == 'unemployed') ? true : null;
